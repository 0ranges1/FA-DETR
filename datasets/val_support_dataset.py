...
class SupportDataset(VisionDataset):
    ...
    Therefore, to check support datasets used during training, please visit dataset.py and val_support_dataset.py
    """
    def __init__(
            self,
            root,
...
def make_support_transforms():
    ...
    For transforms of support images during training, please visit dataset.py and val_support_dataset.py
    """
    normalize = T.Compose([
        T.ToTensor(),
